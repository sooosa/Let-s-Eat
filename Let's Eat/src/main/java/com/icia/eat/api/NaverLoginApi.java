...
public class NaverLoginApi {
	// 애플리케이션 등록 후 발급받은 클라이언트 아이디와 패스워드
		private final static String CLIENT_ID = "90mGHTDdPIYF6eftZSdz";
		private final static String CLIENT_SECRET = "S29F1CC3Ur";
		
		// Callback URL  
		private final static String REDIRECT_URI = "http://localhost:9091/eat/naverloginok";
